...
2. 示例代码：
   ...
   */
   <NavLink to="home" end >home</NavLink>
                     ...
                     <NavLink className={myLiang} to="/about">About</NavLink>
                     <NavLink className={myLiang} to="/home">home</NavLink>
   
     function myLiang(value){
       return value.isActive == true ? "liang" : null
     }
   ```
